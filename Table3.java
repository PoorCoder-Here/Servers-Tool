...
public class Table3 extends AppCompatActivity implements itemnolistener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button serve=findViewById(R.id.ord3);
        Button edit=findViewById(R.id.edt3);
        TextView tot=findViewById(R.id.tot3);
        Button print=findViewById(R.id.prt3);
        Globalclass gb=(Globalclass) getApplicationContext();
        final Intent main=new Intent(Table3.this,MainActivity.class);
        ...
        Intent tab3=getIntent();
        String itno=tab3.getStringExtra("item_no");
        String itna=tab3.getStringExtra("item_name");
        String quanti=tab3.getStringExtra("Q");
        String pri=tab3.getStringExtra("price");
